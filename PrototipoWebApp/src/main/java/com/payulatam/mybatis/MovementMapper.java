...
public interface MovementMapper {
	...
	@Select("select type as typeMovement, count(type) as total from movement where accountid = #{accountId} and (movementdate >= #{initialDate} and movementdate <= #{finalDate}) group by type")
